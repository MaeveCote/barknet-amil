#!/bin/bash
# STAGE 2 + TEST -- patch 224, all 5 folds. Resumes the EXISTING Stage-1 backbones in
# $SCRATCH/runs/abl_p224_nano_f<fold>/pretrain/best_backbone.pth (already trained).
#
...
#
#   sbatch cluster/job_s2_p224.sh
#SBATCH --account=def-oberman_gpu
#SBATCH --job-name=bark_s2_p224
#SBATCH --array=0-4
#SBATCH --gres=gpu:1
...
export EPOCHS_S2=15
export RUN_NAME="abl_p224_nano_f${FOLD}"
