#!/bin/bash
# FULL CV PATCH ABLATION -- STAGE 2 + TEST, large patches. 8h walltime.
# Mirrors job_cv_stage1_large.sh index-for-index so --dependency=aftercorr pairs each
