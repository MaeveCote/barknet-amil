...
train_model.py to initialise the AMIL model for Stage-2 fine-tuning.

Usage:
    python pretrain_backbone.py -c configs/config.yaml
    python pretrain_backbone.py -c configs/config.yaml   # set pretrain.resume: true to continue
"""
import argparse
import csv
import shutil
